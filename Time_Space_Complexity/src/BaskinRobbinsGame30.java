...
public class BaskinRobbinsGame30 {
    ...
    public static void main(String[] args) {
        ...
        int waysToReach31 = baskin(30);
        System.out.println("Number of ways to play Baskin Robbins 31 (30): " + waysToReach31);

        // Example usage with memoization
        int waysToReach31Memo = baskinMemo(30);
        System.out.println("Number of ways to play Baskin Robbins 31 with memoization (30): " + waysToReach31Memo);
