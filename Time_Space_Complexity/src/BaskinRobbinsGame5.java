...
public class BaskinRobbinsGame5 {
    ...
    public static void main(String[] args) {
        ...
        int waysToReach31 = baskin(5);
        System.out.println("Number of ways to play Baskin Robbins 31 (5): " + waysToReach31);

        // Example usage with memoization
        int waysToReach31Memo = baskinMemo(5);
        System.out.println("Number of ways to play Baskin Robbins 31 with memoization (5): " + waysToReach31Memo);
