...
public class BaskinRobbinsGameVs {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of ways to play Baskin Robbins 31 (VS - Initial): " + waysToReach31);



//        // Example usage with memoization
//        int waysToReach31Memo = baskinMemo(31);
//        System.out.println("Number of ways to play Baskin Robbins 31 with memoization (VS - Memo): " + waysToReach31Memo);
