...
public class BaskinRobbinsGame10 {
    ...
    public static void main(String[] args) {
        ...
        int waysToReach31 = baskin(10);
        System.out.println("Number of ways to play Baskin Robbins 31 (10): " + waysToReach31);

        // Example usage with memoization
        int waysToReach31Memo = baskinMemo(10);
        System.out.println("Number of ways to play Baskin Robbins 31 with memoization (10): " + waysToReach31Memo);
