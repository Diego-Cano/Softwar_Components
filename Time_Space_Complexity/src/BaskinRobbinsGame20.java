...
public class BaskinRobbinsGame20 {
    ...
    public static void main(String[] args) {
        ...
        int waysToReach31 = baskin(20);
        System.out.println("Number of ways to play Baskin Robbins 31 (20): " + waysToReach31);

        // Example usage with memoization
        int waysToReach31Memo = baskinMemo(20);
        System.out.println("Number of ways to play Baskin Robbins 31 with memoization (20): " + waysToReach31Memo);
